...
const MEMBERS_DATA = [
    ...
    { id: 3, name: 'John Smith', age: '7 Years', status: 'attended' },
    { id: 4, name: 'John Smith', age: '7 Years', status: 'attended' },
    { id: 5, name: 'John Smith', age: '7 Years', status: 'attended' },
];

export default function ClassDetails({ onBack, onGameClick, classTitle = "Class 1" }) {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <View style={styles.headerLeft}>
                    ...
                    <Text style={styles.headerTitle}>{classTitle}</Text>
                </View>
                <TouchableOpacity style={styles.sessionPlanButton}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                {/* View Game Data Button */}
                <TouchableOpacity style={styles.viewGameBtn} onPress={onGameClick}>
                    <Text style={styles.viewGameText}>View Game Data</Text>
