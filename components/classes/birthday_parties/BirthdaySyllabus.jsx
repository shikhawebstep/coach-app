...
const styles = StyleSheet.create({
    ...
    sessionPlanTitle: { fontSize: 20,  color: '#1a1a1a', marginRight: 12, fontFamily: 'Urbanist_700Bold' },
    sessionPlanTimeContainer: { flexDirection: 'row', alignItems: 'center', marginRight: 'auto' },
    sessionPlanTimeText: { fontSize: 14, color: '#666', fontFamily: 'Urbanist_400Regular' },
    ...
    cardTitle: { fontSize: 15,  color: '#1a1a1a', marginBottom: 4, fontFamily: 'Urbanist_700Bold' },
    cardDesc: { fontSize: 13, color: '#6B7280', lineHeight: 18, marginBottom: 8, fontFamily: 'Urbanist_400Regular' },
    cardTime: { fontSize: 13,  color: '#1a1a1a', fontFamily: 'Urbanist_700Bold' },
    emptyText: { textAlign: 'center', color: '#9CA3AF', marginTop: 32, fontSize: 14, fontFamily: 'Urbanist_400Regular' },
});