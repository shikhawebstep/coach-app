...
const styles = StyleSheet.create({
    ...
    headerTitle: { fontSize: 22, color: '#1a1a1a', fontFamily: 'Urbanist_700Bold' },
    ...
    infoLabel: { fontSize: 13, color: '#9CA3AF',  marginBottom: 4, fontFamily: 'Urbanist_600SemiBold' },
    statusLabel: { fontSize: 13, color: '#9CA3AF', marginBottom: 8, fontFamily: 'Urbanist_600SemiBold' },
    ...
    statusText: { fontSize: 12, color: '#1a1a1a', fontFamily: 'Urbanist_700Bold' },
    ...
    mapFallbackText: { fontSize: 13, color: '#9CA3AF', fontFamily: 'Urbanist_400Regular' },
    locationContainer: { flexDirection: 'row', alignItems: 'flex-start', paddingRight: 16, marginBottom: 20 },
    locationIcon: { marginTop: 2 },
    locationText: { marginLeft: 8, fontSize: 13, color: '#4B5563', lineHeight: 18, fontFamily: 'Urbanist_400Regular' },
    sectionTitle: { fontSize: 18, color: '#4B5563', marginBottom: 16, fontFamily: 'Urbanist_700Bold' },
    formRow: { flexDirection: 'row', marginBottom: 16 },
    formGroup: { marginBottom: 16 },
    inputLabel: { fontSize: 15, color: '#4B5563', marginBottom: 8, fontFamily: 'Urbanist_700Bold' },
    inputContainer: { borderWidth: 1, borderColor: '#9CA3AF', borderRadius: 8, backgroundColor: '#FAFAFA' },
    input: { paddingHorizontal: 16, paddingVertical: 12, fontSize: 16, color: '#1a1a1a', fontFamily: 'Urbanist_400Regular' },
